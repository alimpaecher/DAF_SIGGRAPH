...
\teaser{
\includegraphics{figures/AngelinaHeader.pdf}
  \caption{ Left: twelve drawings of Angelina Jolie, created by DrawAFriend players.  Right: our algorithm automatically corrects a new drawing based on a consensus of the other drawings in the database.}
  \label{fig:teaser}
}
