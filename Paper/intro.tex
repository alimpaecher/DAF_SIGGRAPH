...
We believe this large and growing drawing database will enable a rich stream of future research in graphics. As a first application, we demonstrate how the \daf corpus can be
