...
Drawing as a means of communication dates to well before other forms of
...
portraits. Faces are exceedingly difficult to draw by hand,
...
interface: as players draw, we essentially clean up their drawings by using data from previous drawings of the same subject. We
