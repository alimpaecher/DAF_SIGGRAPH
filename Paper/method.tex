...
\begin{figure}
  \centering%
\includegraphics[height=2in]{figures/imagetable/edges_rd.png}
\hspace{0.1in}
\includegraphics[height=2in]{figures/imagetable/avg_rd_2.png}
...
%\begin{figure}
 % \centering%
%\includegraphics[height=3.25in]{./imagetable/dir_bp.pdf}
...
\begin{figure*}[!t]
  \centering%
\includegraphics[width=7in]{./imagetable/kristenAndObama}
