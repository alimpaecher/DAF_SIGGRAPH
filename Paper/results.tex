...
\begin{figure}
  \centering%
\includegraphics[width=3.5in]{./figures/userstudy/bradConvergence.png}
  \caption{Convergence of the correction vector field as more images are added. Distance from convergence is measured as the mean Euclidean distance of the field from the full set of 131 images used.}
...
Our results show that autocorrect reduced undo rates (the ratio of undos to all other strokes). This effect is magnified for careful drawers (who undid 30\% or more strokes). Their undo rates decreased by a significant 5\% (Wilcoxian p-value = .045).  Before we analyzed the undo rates we removed all drawings that had 0 undos (assuming most of these players did not know undo existed) and all drawings with less than 10 undone strokes (assuming these drawings were not actual attempts to draw the celebrity).  Figure \ref{fig:daf-undo} shows the effect that auto correction has on decorating undo rates, particularly for more careful drawers. We view the drop in undo rates as an improvement in how players view their own drawings.

\begin{figure}
  \centering%
\includegraphics[width=3.5in]{./figures/userstudy/undoRates_chart.png}
  \caption{Percentile undo rates for the auto corrected and not auto corrected drawings, sorted in ascending order. Note how the auto correction results in the decrease of undo rates, particularly for more careful drawers.}
  \label{fig:daf-undo}
\end{figure}
