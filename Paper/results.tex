...
\includegraphics[width=3.5in]{./figures/userstudy/undoRates_chart.png}
  \caption{Percentile undo rates for the auto-corrected and non auto-corrected drawings, sorted in ascending order. Note how the stroke auto correction decreases undo rates, particularly for more careful drawers.}
  \label{fig:daf-undo}
\end{figure}
